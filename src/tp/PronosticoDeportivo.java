...
public class PronosticoDeportivo {
    ...
    public Equipo[] cargarEquipos() {
        ...
        "Almirante Brown", "Arsenal", "San Lorenzo", "ColÃ³n de Santa FÃ©"};
    ...
    public Partido[] cargarPartidos() {
        ...
        // mÃ¡xima de partidos es la cantidad de equipos / 2
        // creo un vector de ese tamaÃ±o y lo asigno a atributo partidos
        this.partidos = new Partido[(this.getEquipos().length/2)];
        // Ahora hay que cargar los partidos en el vector, creÃ¡ndolos de a uno
    ...
    public void cargarPronosticos() {
        ...
        for (int participante = 0; participante<this.getParticipantes().length; participante++) {
            ...
            for (int partido=0; partido<this.getPartidos().length; partido++) {
                // Para cada partido generar un pronÃ³stico
                ...
                // Cargar el pronÃ³stico en el array de pronÃ³sticos
                prons[partido] = pron;
            }
            // Cuando terminÃ© los pronÃ³sticos de cada partido
